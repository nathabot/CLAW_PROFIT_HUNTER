...
class PaperTraderV5 {
  ...
  writePositiveStrategies(strategies, currentCycle) {
    ...
    if (strategies.length === 0) {
      content += `*No strategies currently meet the 70% WR threshold*\n\n`;
    }
    ...
    content += `---\n\n`;
    content += `**Note:** Strategies are valid for 1 cycle only. After each 50-simulation cycle, all strategies are re-evaluated. Only strategies maintaining ≥70% WR remain in Positive.\n`;
