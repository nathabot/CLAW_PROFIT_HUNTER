...
class DynamicTrader {
  ...
  moveStrategyToNegative(strategyId, strategyName, tracker) {
    ...
    try {
      ...
      content = '# 17 - Negative Strategies (WR <65% or 3+ Live Losses)\n\n**Auto-generated by Live Trader + Paper Trader**\n\n';
    }
  ...
  confirmPositiveStrategy(strategyId, strategyName, tracker) {
    ...
    try {
      ...
      content = '# 16 - Positive Strategies (WR >=65%)\n\n**Auto-generated by Paper Trader v5**\n\n';
    }
    ...
    content = content.replace('*No strategies currently meet the 65% WR threshold*', '');
